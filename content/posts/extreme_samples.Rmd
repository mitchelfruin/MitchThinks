...
> 2. Counties that are in the highest decile of the cancer distribution tend to be rural and located in the Midwest, the South, and the West.
...
Did Kahneman add the sparsely populated and do their own experiment?

This pair of facts illustrate the sarcastically named 'law of small numbers'. It, tongue-in-cheek, states that the law of large numbers, that samples reflect populations, applies to small numbers too. It is more intuitively referred to as **sample size neglect**. Ignorring the sample size when making inferences. 

The key here isn't the *behaviour* of people who live in rural areas, it's the *number* of people who live in rural areas.   
