...
<center>
![Archimedes' first step](/images/estimate_pi.png)
</center>
...
Hopefully the plan is starting to become clear. We need to calculate the proportion of random points that are inside the circle. 
...
That's an ok estimate but what if we wanted a greater degree of accuracy. All we need to do is use a greater number of random points. 
...
Now, the proportion of points inside the circle is `r prop_inside` giving us an estimate for $\pi$ of `r pi_estimate`. 
