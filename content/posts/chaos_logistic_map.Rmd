...
I made my own version by simulating 150 generations across a range of starting values and values of $a$. 

```{r}
bifurc_sim <- multiple_map(x_opts = seq(0.01, 0.99, 0.01),
...
Each dot represents the population proportion in the 200th generation of one simulation. Hopefully you recognise the pattern as $a$ increases. We see stable equilibria, followed by 2-period cycling, and then 4-period cycling, the 8-period cycling is just about perceptible, and then we're into chaotic territory.
