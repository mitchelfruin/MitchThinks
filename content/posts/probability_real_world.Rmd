...
For one thing, a courtroom trial represents the prototypical hypothesis test. We have the null hypothesis, $H_0$, that the defendent is innocent (this is the null because of the presumption of innocence). We have the alternative hypothesis, $H_1$, that the defendent is guilty. And the trial involves the presentation of evidence to help the jury decide whether they should reject $H_0$ and convict. 

Second, a courtroom analogy is often used to teach the types of potential error when conducting hypothesis tests. In fact, I still remind myself that a type 1 error involves 'sending an innocent man to prison' (rejecting a true null hypothesis) whilst a type 2 error involves 'letting a guilty man go free' (failing to reject a false null hypothesis). 
