...
Particularly when making large scale policy decisions, engaging in such painfully slow thinking is crucial. If you don't, then you run the risk of misattributing run-of-the-mill statistical variation to an incorrect, but compelling, narrative like the wonders (and horrors) of the rural lifestyle. For example, the Wainer and Zwerling article I began this post with focused on a $1.7 billion investment by the Bill & Melinda Gates foundation made to follow up on research on what makes schools successful. One apparent finding in such research is that amongst the most successful schools, small schools are overrepresented. This led the foundation along with the U.S Department of Education Smaller Learning Communities Program to make substantial investment in the creation of smaller schools. It's easy to construct a compelling narrative to explain why small schools cause better educational outcomes, perhaps appealing to there being more personal attention or individual encouragement for each student. However, as Wainer and Zwerling point out, small schools are also overrepresented when you look at the worst schools. Why? Because, please remember this mantra if you ever get an important job that affects millions of people's lives, small samples produce extreme results more often.
