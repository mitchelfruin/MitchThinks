...
However, the apparent spike in burglaries is just an artefact of the fact that 5 year's worth of increase has been squeezed into one notch on the x-axis. 

## Elongated

Discontinuous axes make a change look more extreme by removing values, but we can also exaggerate changes by adding in irrelevant blank values. 
