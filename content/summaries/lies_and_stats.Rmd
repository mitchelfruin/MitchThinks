...
set.seed(23)
maths_test <- tibble(student = c(1:30), 
                     score = rnorm(30, 50, 20))
```
...
For instance, say your parents were on your case about your latest maths test and you were so committed to deceiving them that you whipped up a histogram that showed your score of 70 pretty favourably:

```{r favourable grouping}
# Histogram with favourable grouping
ggplot(maths_test, aes(x = score)) +
  geom_histogram()
```
...
If you're writing your own reports then use equal bins widths, either in percentile or absolute terms. 
